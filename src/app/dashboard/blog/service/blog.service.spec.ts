...
describe('BlogForm-AdminService', () => {
  ...
  it('Blog service have a getById() method', () => {
    expect(blogService.getById).toBeDefined();
  });

  it('Blog service have a delete() method', () => {
    expect(blogService.delete).toBeDefined();
  });

  it('Blog service have a listUpdated() method', () => {
    expect(blogService.listUpdated).toBeDefined();
  });
  ...
  it('Blog service POST', () => {
    ...
    blogService.save(dummyBlog).subscribe((respone: Blog) => {
